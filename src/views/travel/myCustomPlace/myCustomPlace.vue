    ...
    <div>
      ...
      <el-table
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button icon="el-icon-star-off" type="warning" size="small" @click="addPlaceCollection(scope.row)">收藏</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
            ...
            tableData:[
              {
                ...
                link:'http://api.map.baidu.com/place/detail?uid=b9e20c7db1f01327f32d83fe&output=html&source=placeapi_v2',
                tag:'房地产;宿舍',
